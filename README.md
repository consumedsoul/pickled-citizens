...
- `app/`
  ...
  - `profile/` – user profile management (name, gender, DUPR, league memberships).
...
- `supabase/`
  - `schema.sql` – database schema for profiles, leagues, league_members, sessions, matches, match_players, match_results, admin_events, plus RLS policies.
